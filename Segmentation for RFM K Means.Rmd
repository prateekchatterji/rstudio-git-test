...
```{r Tidying Data, warning=FALSE, message=FALSE}
...
```{r Adding Geographic Constraints, warning=FALSE, message=FALSE}
table(data$Country)
...
```{r Complete Dataset, warning=FALSE, message=FALSE}
...
```{r Identify Returns , warning=FALSE, message=FALSE}
...
```{r Create customer level dataset, warning=FALSE, message=FALSE}
...
```{r Recenc, warning=FALSE, message=FALSE}
...
```{r Monetary Value, warning=FALSE, message=FALSE}
...
```{r Vizualize Data log Transformed, warning=FALSE, message=FALSE}
# Log-transformed
...
```{r Handling OUtliers, warning=FALSE, message=FALSE}
...
```{r Scaled Variables, warning=FALSE, message=FALSE}
...
```{r Determine number of clusters, warning=FALSE, message=FALSE}
...
```{r Elbow Skree Plot, warning=FALSE, message=FALSE}
library(ggplot2)
library(scales)
...
```{r NbClust, warning=FALSE, message=FALSE}
...
```{r Plot clusters in 3D, warning=FALSE, message=FALSE}
colors <- c('red','orange','green3','deepskyblue','blue','darkorchid4','violet','pink1','tan3','black')
